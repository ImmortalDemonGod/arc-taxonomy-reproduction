...
def main():
    ...
    # Secondary checkpoint for headline metric
    checkpoint_acc = ModelCheckpoint(
        dirpath="checkpoints/exp0_encoder_decoder",
        filename="encoder_decoder-acc-{epoch:02d}-{val_grid_accuracy:.4f}",
    ...
    print(f"Checkpoints will be saved to: checkpoints/exp0_encoder_decoder/\n")
